    ...
    return (
        <ScrollView>
            <View className="bg-gray-100 mt-8">
                ...
                <View className='flex-row items-center p-2 bg-white justify-center shadow-md gap-3'>
                    <TouchableOpacity onPress={() => navigation.navigate('MainTabs', { screen: 'Home' })}>
                        <View className="bg-gray-200 rounded-full p-2">
                            <FontAwesome5 name="arrow-left" size={20} color="black" />
                        </View>
                    </TouchableOpacity>
                    <View className="flex-row items-center bg-gray-200 rounded-full w-[70%] h-10 mr-10">
                        <TextInput
